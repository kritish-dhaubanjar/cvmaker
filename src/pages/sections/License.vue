<template>
  <div class="container">
    <h3>What driving licenses do you want to highlight?</h3>
    ...
    <div class="row">
      <div class="col-12 col-sm-12 col-md-12 col-lg-8">
        ...
        <button class="btn btn-success btn-block my-4" @click.prevent="addLicense">ADD ONE MORE</button>
      </div>

      <div class="col-12 col-sm-12 col-md-12 col-lg-4">
        <p class="lead">Showing results for driving licenses</p>
        <div class="input-group">
          <input
            type="text"
            class="form-control"
            placeholder="Ex. Driving License"
            v-model="search"
          />
...
export default {
  ...
  computed: {
    disabled() {
      let empty = false;
      // this.data.data.forEach(license => {
  ...
  methods: {
    ...
    addToLicense(index) {
      this.data.data.push({
        license: this.suggestions[index],
        addToSuggestion: false
      });
    }
  },
